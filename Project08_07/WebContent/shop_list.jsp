...
<script>
	function view(temp) {
		if (temp.length > 0) {
			url = "http://localhost:8080/Project08_07/upload/" + temp;
...
<body>
	<p align=center>
		<font color=#0000ff face=굴림 size=3> <strong>쇼핑하기</strong>
		</font>
	</p>
	...
	<form method=post name=search action="shop_list.jsp">
		<table border=0 width=95%>
			<tr>
				<th align=right><font size=01>상품명으로 찾기</font> <input type=text
					name=pname> <input type=submit value="검색"></th>
			</tr>
			<tr>
				<th><font size=-1> [<a href="main.html">메인으로</a>] 
				<a href="shop_list.jsp">전체</a> <a href="shop_list.jsp?cat=11">가구</a>
						<a href="shop_list.jsp?cat=22">전기/전자</a> <a
						href="shop_list.jsp?cat=33">부엌용품</a> <a
						href="shop_list.jsp?cat=44">의류</a> <a href="shop_list.jsp?cat=55">보석
							및 악세사리</a> <a href="shop_list.jsp?cat=66">헬스 기구</a> <a
						href="shop_list.jsp?cat=77">컴퓨터 관련</a> <a
						href="shop_list.jsp?cat=88">기타</a>
				</font></th>
		</table>
	</form>
	<center>

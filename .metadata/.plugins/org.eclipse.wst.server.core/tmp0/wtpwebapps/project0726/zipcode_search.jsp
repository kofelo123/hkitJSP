...
<table align="center" width="95%" border="0" cellspacing="0" cellpadding="3" bordercolor="#999999" class="style2">
	<tr align="center">
		...
		<td width="73%" bgcolor="#E7EDFE"><font color="#999999">주 소</font></td>
	</tr>
</table>
...
%>
	<tr bgcolor="#9999CC">
		<td width="27%" bordercolor="#CCCCCC" bgcolor="#FFFFFF" align="center"><a href="javascript:choiceZipcode('<%=zipcode %>','<%=address1 %>')">
		<%=zipcode %></a></td><td width="73%" bordercolor="#999999" bgcolor="#FFFFFF"><a href="javascript: choiceZipcode('<%=zipcode %>','<%=address1 %>')">
		<%=address %></a></td>
		</tr>
	<%
		}

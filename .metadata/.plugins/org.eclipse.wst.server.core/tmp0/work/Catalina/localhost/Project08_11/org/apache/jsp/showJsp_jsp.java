 ...
 * Generated at: 2017-08-17 12:35:54 UTC
...
return;
	...
	//분기문 필요할것
	if(val == null )
		datas=addrDaoBean.getAddressList();
	else{//검색없이도 val=null 만으로도 아래가실행된다.
		switch(searchVal){
		case "name":
		...
		case "nameMemo":
			...
			datas=addrDaoBean.getSearchAddressList(searchSql);
	...
	if(endpage>totalpages)
      ...
      out.write("\tlocation.href=\"new_modify.jsp?id=\"+id+\"&pass=\"+pass;\r\n");
      out.write("}\r\n");
      ...
      out.write("</head>\r\n");
      out.write("<body>\r\n");
      out.write("\t<a href=\"new_insert.jsp\">주소록등록</a>\r\n");
      out.write("\t<form method=\"get\" name=\"search\" action=\"showJsp.jsp\">\r\n");
      out.write("<tr>\r\n");
...
if(wheregroup > 1){
		...
		out.print("[<a href=showJsp.jsp?gogroup=1&val="+val+"&search="+searchVal+">처음</a>]");
		out.print("[<a href=showJsp.jsp?gogroup="+priorgroup+"&val="+val+"&search="+searchVal+">이전</a>]");
	}else{
	...
	if(datas.size() !=0){
		for(int jj=startpage; jj<=endpage; jj++){
			if(jj==where){
				...
				out.print("<a href=showJsp.jsp?go="+jj+"&val="+val+"&search="+searchVal+">["+jj+"]</a>");
		}
		
		}
	}
	if(wheregroup < totalgroup){
		out.print("[<a href=showJsp.jsp?gogroup=" + nextgroup+"&val="+val+"&search="+searchVal+">다음</a>]");
		out.print("[<a href=showJsp.jsp?gogroup="+ totalgroup+"&val="+val+"&search="+searchVal+">마지막</a>]");
	}else{
		out.println("[다음]");
		out.println("[마지막]");
	}
